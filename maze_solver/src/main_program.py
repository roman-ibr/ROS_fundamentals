...
from basics_exam.msg import record_odomFeedback, record_odomResult, record_odomAction, record_odomGoal
...
my_service_client = rospy.ServiceProxy('/crash_direction_service', Trigger)
